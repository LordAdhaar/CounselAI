"use client";
import { ChevronDown, ChevronUp, Glasses, Loader2, RotateCw, Search } from "lucide-react";
...
export default function PdfRenderer({url}: PdfRendererProps ){
    ...
    return(
        <div className="w-full bg-white rounded-md shadow flex flex-col items-center">
            ...
            {/* Top Bar with rotate, page number, etc*/}
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <div className="flex items-center gap-1.5">
                        ...
                        <p className="text-zinc-700 text-sm space-x-1 flex items-center">
                            <span > &nbsp; / &nbsp;</span>
                            <span className="text-lg font-normal">{numPages ?? "X"}</span>
                        </p>
                    </div>
